if (APPLE AND IOS_PLATFORM)
    ...
    set (SDL2_PATH ${BELEZA_SOURCE_DIR}/SDL)
    ...
    set (SDL2IMAGE ${BELEZA_SOURCE_DIR}/SDL_image)
    ...
    set (SDL2TTF ${BELEZA_SOURCE_DIR}/SDL_ttf)
    ...
    set (SDL2MIXER ${BELEZA_SOURCE_DIR}/SDL_mixer)
